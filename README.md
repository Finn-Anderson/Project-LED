...
Project LED allows you to control the mode (music, solid light, facial expressions or off), which device to listen to (input & output devices), solid light colour, timer between no music and switching to chosen solid light colour, brightness and ip address.